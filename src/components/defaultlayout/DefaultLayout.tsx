      ...
      <StyledDefaultLayout.Header>
        <StyledDefaultLayout.HeaderContent>
          ...
          <StyledDefaultLayout.Menu>
            <StyledDefaultLayout.MenuItem as={NavLink} to="/" className={({ isActive }) => (isActive ? "active" : "")}>
              Filmes favoritos
            </StyledDefaultLayout.MenuItem>
            <StyledDefaultLayout.MenuItem as={NavLink} to="/Movies" className={({ isActive }) => (isActive ? "active" : "")}>
              Todos os filmes
            </StyledDefaultLayout.MenuItem>
          </StyledDefaultLayout.Menu>
        </StyledDefaultLayout.HeaderContent>
      </StyledDefaultLayout.Header>
      <StyledDefaultLayout.Content>{children}</StyledDefaultLayout.Content>
    </StyledDefaultLayout.Container>
  );
}
